...
0. Create `.env` file in the root directory and add the following environment variables:
```env
SWAGGER_URL=<SWAGGER_URL>/v3/api-docs
OPENAI_API_KEY=<YOUR_OPENAI_API_KEY>
ROOT_FILES_PATH=/src/swagger
```

4. Link the Script to global packages - from this package directory:
